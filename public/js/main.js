/**
 * Created by jyhuang on 2017/2/24.
 */
...
$(function(){
    $(".menu_btn").each(function(index,el){
        $(el).hover(function(){
            var html='<div style="width: 100%;height: 100px;background-color:#000; opacity:0.7;filter:alpha(opacity=70); display: none;" class="zcd"> </div>';
            $(".menu_child_div").html(html);
            $(".zcd").fadeIn(500);
